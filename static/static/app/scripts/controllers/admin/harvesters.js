...
.controller("harvesterPaymentsCtrl", function($http, $q,$location, $timeout,toastr,$route, $scope){
    $scope.amount = {}
...
.controller("editHarvesterDetailsCtrl", function($http, $q, $timeout,toastr,$route, $scope){
...
.controller("createHarvesterCtrl", function ($scope, $http, $q,$location,$timeout, $route, toastr){
